...
public class Config {
	...
	public static final String MODEL_ROOT = PROJECT_ROOT + "/model";
...
//		public static final String MODEL_SETTING = "N=20,K=2";
	...
	public static String ORIG_MODEL_FILE = MODEL_ROOT + "/" + MODEL_NAME + "/" + MODEL_NAME + ".pm";
	public static String modelPath = "/"+MODEL_NAME+"/" + MODEL_SETTING +"/paths";
	public static String DATA_PATH = MODEL_ROOT + modelPath;
	public static String OUTPUT_MODEL_PATH = MODEL_ROOT + "/" + MODEL_NAME + "/" + MODEL_SETTING + "/lar_models";
	public static String TESTING_PATH = MODEL_ROOT + "/" + MODEL_NAME + "/" + MODEL_SETTING + "/lar_paths";
	public static String AA_OUTPUT_PATH = MODEL_ROOT + "/" + MODEL_NAME + "/" + MODEL_SETTING + "/AA";
	public static String GA_OUTPUT_PATH = MODEL_ROOT + "/" + MODEL_NAME + "/" + MODEL_SETTING + "/GA";

	// property setting
	public static String PROPERTY_LEARN_FILE = MODEL_ROOT + "/" + MODEL_NAME + "/" + MODEL_NAME + "_learn.pctl";
	public static String PROPERTY_FILE = MODEL_ROOT + "/" + MODEL_NAME + "/" + MODEL_NAME + ".pctl";
