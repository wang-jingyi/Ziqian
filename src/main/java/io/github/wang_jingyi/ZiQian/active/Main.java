...
//				,
		...
		for(int sn : stateNumber){
			...
			for(int numSample : sampleSize){
				...
				double idoTargetFrequency = 0, rsTargetFrequency = 0; 
				double idoMinFrequency = 0, rsMinFrequency = 0;
				int reachzero = 0;
...
//				idomser.add(imser/repeatTime);
				...
				idoreach.add(ireach/(repeatTime-reachzero));
//				idoreachr.add(ireachr/repeatTime);
				rsreach.add(rreach/(repeatTime-reachzero));
			}
