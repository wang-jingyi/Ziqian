...
public class SwatSimulation {
	...
	public static void simulate(int sampleSize, int recordStep, int runningTime, String dp, int sc){
		String[] simulateCommand = new String[]{"python",PlatformDependent.SWAT_SIMULATE_PATH+"/JingyiRS.py",String.valueOf(sampleSize)
	...
	public static void main(String[] args) throws IOException{
		...
		for(int i=1000; i<=10000; i++){
			...
			SwatSimulation.simulate(5, 1, 1,Config.DATA_PATH, i);
		}
	}
